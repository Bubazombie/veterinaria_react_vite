  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5">
        ...
        <div className="mb-5">
          <label htmlFor="humano" className="block text-gray-700 uppercase font-bold">Nombre Humano</label>
          <input id="humano" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" type="text" placeholder="Nombre del humano" value={humano} onChange={ (e)=> setHumano(e.target.value) } />
        </div>
        <div className="mb-5">
        ...
        <div className="mb-5">
          ...
          <textarea name="" id="sintomas" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" placeholder="Describe los síntomas" value={sintomas} onChange={ (e)=> setSintomas(e.target.value) }></textarea>
        </div>
